...
export default function DaeguRegionPage() {
  const faqs = [
    {
      q: "대구 지역의 장기요양 서비스는 어떻게 확인하나요?",
      a: "대구시 및 구·군 복지센터에서 지역별 안내와 절차를 제공합니다. 이 페이지는 안내용이며, 공식 정보는 관할 기관에서 확인하세요.",
    },
    {
      q: "대구에서 방문요양 신청은 어디서 하나요?",
      a: "수급자격 판정 이후 관할 복지센터 또는 지정 기관을 통해 신청이 가능합니다. 세부 절차는 관할 기관에 문의하세요.",
    },
    {
      q: "대구 지역 지원 정책은 어디서 확인하나요?",
      a: "지자체별 지원 항목과 기준이 다르므로 대구시 복지포털 및 구청 공지를 확인하시기 바랍니다.",
    },
    {
      q: "서비스 제공기관을 선택할 때 주의할 점은?",
      a: "기관 인증 여부, 제공 가능한 서비스 범위, 이용자 후기 등을 확인하고 사전 상담을 권장합니다.",
    },
  ];
    ...
    <main className="min-h-screen bg-slate-50 text-slate-800">
      ...
      <section className="mx-auto w-full max-w-4xl px-4 py-6 sm:px-6 sm:py-10">
        <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8">
          <p className="inline-flex rounded-full bg-blue-50 px-3 py-1 text-xs font-medium text-blue-700">지역 안내 — 대구</p>
          <h1 className="mt-3 text-2xl font-bold leading-tight text-slate-900 sm:text-4xl">대구 지역 장기요양 & 방문요양 안내</h1>
          <p className="mt-4 text-sm leading-6 text-slate-700 sm:text-base">대구 지역의 장기요양·방문요양 관련 일반 안내입니다. 구체적인 정책과 절차는 관할 기관에서 확인하세요.</p>
        </div>
